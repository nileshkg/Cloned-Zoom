...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private AppCompatButton buttonSignInWithMobile;
    ...
    private void initViews() {
        ...
        buttonSignInWithMobile = findViewById(R.id.btnLoginWithMobile);
    ...
    private void clickListener() {
        ...
        buttonSignInWithMobile.setOnClickListener(this);
    ...
    private void configureGoogleSignIn() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("128466199681-blcu8mrigo1gi1fe1tcndkm4g0vqlrtf.apps.googleusercontent.com")
                .requestEmail()
                .build();
