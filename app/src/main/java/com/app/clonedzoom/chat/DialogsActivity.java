...
import com.app.clonedzoom.chat.async.BaseAsyncTask;
...
import com.app.clonedzoom.chat.qb.callback.QBPushSubscribeListenerImpl;
import com.app.clonedzoom.chat.qb.callback.QbEntityCallbackImpl;
...
public class DialogsActivity extends BaseActivity implements DialogsManager.ManagingDialogsCallbacks {
    ...
    private void initUi() {
        ...
        refreshLayout.setColorSchemeResources(R.color.color_primary, R.color.random_color_2, R.color.random_color_3, R.color.random_color_7);
    }
        ...
        ChatHelper.getInstance().createDialogWithSelectedUsers(selectedUsers, chatName,
                new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog dialog, Bundle args) {
                        ...
                        dialogs.add(dialog);
                        new DialogJoinerAsyncTask( dialogs).execute();
    ...
    private void loadDialogsFromQb(final boolean silentUpdate, final boolean clearDialogHolder) {
        ...
        ChatHelper.getInstance().getDialogs(requestBuilder, new QBEntityCallback<ArrayList<QBChatDialog>>() {
            ...
            public void onSuccess(ArrayList<QBChatDialog> dialogs, Bundle bundle) {
                ...
                DialogJoinerAsyncTask joinerTask = new DialogJoinerAsyncTask( dialogs);
    ...
    public static class DialogJoinerAsyncTask extends BaseAsyncTask<Void, Void, Void> {
        ...
        public  DialogJoinerAsyncTask( ArrayList<QBChatDialog> dialogs) {
