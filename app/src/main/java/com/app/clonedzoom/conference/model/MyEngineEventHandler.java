package com.app.clonedzoom.conference.model;
...
public class MyEngineEventHandler extends IRtcEngineEventHandler {
    ...
    public void onConnectionLost() {
        ...
        while (it.hasNext()) {
            AGEventHandler handler = it.next();
            if (handler instanceof DuringCallEventHandler) {
                ((DuringCallEventHandler) handler).onExtraCallback(AGEventHandler.EVENT_TYPE_ON_APP_ERROR, Constants.AppError.NO_CONNECTION_ERROR);
            }
        }
    }
